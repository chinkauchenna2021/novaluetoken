...
export declare namespace BaseDoubleDice {
  export type CreatedVirtualFloorParamsStruct = {
    betaOpen_e18: BigNumberish;
    totalFeeRate_e18: BigNumberish;
    protocolFeeRate_e18: BigNumberish;
    tOpen: BigNumberish;
    tClose: BigNumberish;
    tResolve: BigNumberish;
    nOutcomes: BigNumberish;
...
export interface SimpleOracleInterface extends utils.Interface {
  functions: {
    ...
    "initialize((string,address,uint256,string))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BaseDoubleDice.BaseDoubleDiceInitParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface ContractURIUpdateEventObject {
  contractURI: string;
}
export type ContractURIUpdateEvent = TypedEvent<
  [string],
  ContractURIUpdateEventObject
>;
...
export interface UserCommitmentEventObject {
  vfId: BigNumber;
  committer: string;
  outcomeIndex: number;
  timeslot: BigNumber;
...
export interface SimpleOracle extends BaseContract {
  ...
  functions: {
    ...
    getVirtualFloorParams(
      vfId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BaseDoubleDice.CreatedVirtualFloorParamsStructOutput]>;
    ...
    setPlatformFeeBeneficiary(
      protocolFeeBeneficiary_: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setPlatformFeeRate_e18(
      protocolFeeRate_e18_: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
