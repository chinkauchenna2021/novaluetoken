...
export interface DummyUSDTetherInterface extends utils.Interface {
  functions: {
...
export interface DummyUSDTether extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DummyUSDTetherInterface;
  ...
  callStatic: {
    ...
    setLockTime(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
