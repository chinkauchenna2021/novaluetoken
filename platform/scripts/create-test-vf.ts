...
import { DoubleDice__factory, DummyUSDCoin__factory, encodeVirtualFloorMetadata , DummyUSDTether__factory} from '../lib/contracts';
import { validateRoomEventInfo } from '../lib/metadata';

const TOKEN_CONTRACT_ADDRESS = '0x8E723467f28B80e5016Ce72a90fe5bE16B94D698';
const PLATFORM_CONTRACT_ADDRESS = '0x5848A6Df71aE96e9C7544fC07815Ab5B13530c6b';
...
async function main() {
  ...
  const token = new DummyUSDTether__factory(owner).attach(TOKEN_CONTRACT_ADDRESS);
